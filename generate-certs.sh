...
echo "  server_good.pem   (good EKU: serverAuth)"
echo "  server_wrong.pem  (wrong EKU: clientAuth)"
echo "  server_noeku.pem  (no EKU)"
echo ""
echo "CLIENT CERTIFICATES:"
echo "  client_good.pem   (good EKU: clientAuth)"
echo "  client_wrong.pem  (wrong EKU: serverAuth)"
echo "  client_noeku.pem  (no EKU)"
echo ""
echo "===== START NGINX ====="
